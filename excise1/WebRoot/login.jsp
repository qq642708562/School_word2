...
<head>
    ...
    <script>
        function changeImg(){
        document.getElementById("vcodeImg").src="CreateVerifyImage?t="+Math.random();
    }
    </script>
</head>
<body style="background-image: url(./image/3.JPG); background-position: center center; background-size: 100%;">
    ...
    <form class="box" action="LoginController" method="post">
        ...
        <img id="vcodeImg" style="cursor: pointer;" src="CreateVerifyImage" onclick="changeImg();" title="看不起，换一个" />
